...
Second, by switching from full-length coverage to 3' sequencing, InDrop and Drop-Seq could incorporate molecular barcodes (
% todo manu found this confusing. UMIs) into their capture primers (Figure~\ref{fig:indrop-dropseq}~B). 
...
SEQC is fully modular, and as such has been adapted to process drop-seq, 10x, and mars-seq data.  
