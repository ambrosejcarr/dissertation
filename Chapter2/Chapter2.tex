...
% todo I do definitely need a figure here; I need to explain droplet sequencing a bit before explaining how they differ. 
...
% todo this section should incorporate a lot of the thesis background explanation (I should be able to start by copying from slides, for the most part.  
...
% todo I can incorporate the motivation here from the talk
...
% todo I can incorporate the better motivation and figures from the talk here
...
% todo I can include the simplified error correction figure here
\section{Molecular Identifier Correction}

% todo reference earlier figure describing errors; and/or manu would prefer we add a figure to describe how this works. 
...
However, we observed that this model can be overly stringent, correcting UMIs when the donor molecule has as few as one read count higher than the recipient. % todo manu wants a figure here. 
...
% todo I have some multi-alignment correction figures in the talk that could be included here
...
% todo add seqc vs no-seqc figures here
\section{SEQC identifies hidden biology}
